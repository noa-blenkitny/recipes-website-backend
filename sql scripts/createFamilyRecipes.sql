...
-- VALUES (1, 6, 'Grandma''s Brownies', 'Grandma Aviva makes this brownies for every grandchild''s birthday!',45,'https://img.delicious.com.au/PKWN2rUp/w759-h506-cfill/del/2015/10/gingerbread-brownies-14280-1.jpg',
...
-- -- Pizza
-- INSERT INTO mydb.familyRecipes (recipe_id, user_id, title, summary, readyInMinutes, image,aggregateLikes, vegan, vegetarian, glutenFree, servings,  extendedIngredients, analyzedInstructions)
-- VALUES (2, 6, 'Karel''s Pizza', 'Mother Karel makes this special pizza when My Family and I gather for family evenings and enjoy quality time together',140,'https://realfood.tesco.com/media/images/1400x919-MargaritaPizza-555a4065-2573-4b41-bcf3-7193cd095d8f-0-1400x919.jpg',
...
-- -- quiche
INSERT INTO mydb.familyRecipes (recipe_id, user_id, title, summary, readyInMinutes, image,aggregateLikes, vegan, vegetarian, glutenFree, servings,  extendedIngredients, analyzedInstructions)
VALUES (3, 6, 'Tal''s Broccoli Quiche', 'Father Tal makes this yummi broccoli quiche every year for Shavuot eve',50,'https://www.foodisgood.co.il/wp-content/uploads/2017/07/broccoli-quiche.jpg',
